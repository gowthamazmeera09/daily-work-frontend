        ...
        <div>
            <form className="max-w-sm mx-auto my-24" onSubmit={handlesubmit}>
                ...
                <div className="mb-5">
                    ...
                    <input type="file" onChange={(e) => setSelectedFile(e.target.files[0])} onClick={(e)=>setSelectedFile(e.target.files[0])} className="shadow-sm bg-gray-50 border text-gray-900 text-sm rounded-lg block w-full p-2.5" required />
                </div>
